...
import loupe from "../../img/Vector.svg";
import wishlist from "../../img/wishlist-icon.svg";
import burger from "../../img/Rectangle.svg";
import bag from "../../img/shopping-cart-icon.svg";
      ...
      <div className="header__bigContainer">
        <div className="header__mainContainer">
          ...
          <div className="header__rightUpperContainer">
            ...
            {signInIsVisible && <p className="header__page" onClick={showAccount}>SIGN IN </p>}
            {signOutIsVisible && <p className="header__page" onClick={signOut}>SIGN OUT</p>}
